"""
Changi AeroVision - CNN Demo Web Application
...
from src.CNN_config import NUM_CLASSES, AIRCRAFT_CLASSES
import os

# Use AIRCRAFT_CLASSES as CLASS_NAMES
CLASS_NAMES = AIRCRAFT_CLASSES
...
if __name__ == '__main__':
    print("\n" + "="*70)
    print("CHANGI AEROVISION - CNN DEMO WEB APPLICATION")
    print("="*70)
